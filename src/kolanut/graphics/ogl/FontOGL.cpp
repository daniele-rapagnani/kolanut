...
bool FontOGL::load(const std::string& file, size_t size)
{
    this->size = size;
    ...
    this->texture = std::make_shared<TextureOGL>();
...
Font::Glyph FontOGL::createGlyphInfo(int codepoint) const
{
    Glyph g;
...
const Font::Glyph* FontOGL::getGlyphInfo(int codepoint) const
{
