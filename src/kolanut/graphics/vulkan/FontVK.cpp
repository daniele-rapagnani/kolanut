...
bool FontVK::load(const std::string& file, size_t size)
{
    this->size = size;
    ...
    this->texture = std::make_shared<TextureVK>();
...
Font::Glyph FontVK::createGlyphInfo(int codepoint) const
{
    Glyph g;
...
const Font::Glyph* FontVK::getGlyphInfo(int codepoint) const
{
